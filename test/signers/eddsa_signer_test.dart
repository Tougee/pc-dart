...
void main() {
  group('test from RFC8032', () {
    test('test sign1', () {
      ...
      var message = Uint8List.fromList(HEX.decode(''));
      var signature = edDSASign(EdDSAPrivateKey(ed.PrivateKey(sk)), message);
      expect(
          signature,
    ...
    test('test sign2', () {
      ...
      var message = Uint8List.fromList(HEX.decode('72'));
      var signature = edDSASign(EdDSAPrivateKey(ed.PrivateKey(sk)), message);
      expect(
          signature,
          Uint8List.fromList(HEX.decode(
    ...
    test('test sign3', () {
      ...
      var message = Uint8List.fromList(HEX.decode('af82'));
      var signature = edDSASign(EdDSAPrivateKey(ed.PrivateKey(sk)), message);
      expect(
          signature,
          Uint8List.fromList(HEX.decode(
